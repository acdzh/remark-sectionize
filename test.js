...
When will it end?
  ...
  const expected = u('root', {}, [
    u('section', { depth: 1, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h1' } } }, [
      u('heading', { depth: 1 }, [u('text', { value: 'Heading 1' })]),
      u('paragraph', {}, [u('text', { value: 'Some text under heading 1.' })]),
      u('section', { depth: 2, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h2' } } }, [
      ...
      u('section', { depth: 2, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h2' } } }, [
        ...
        u('section', { depth: 3, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h3' } } }, [
          u('heading', { depth: 3 }, [u('text', { value: 'Heading 1.2.1' })]),
          u('blockquote', {}, [
            u('paragraph', {}, [u('text', { value: 'Blockquote' })])
          ]),
          u('paragraph', {}, [u('text', { value: 'Text.' })]),
          u('section', { depth: 5, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h5' } } }, [
    ...
    u('section', { depth: 1, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h1' } } }, [
      ...
      u('section', { depth: 6, data: { hName: 'section', hProperties: { className: 'remark-sectionize-h6' } } }, [
        u('heading', { depth: 6 }, [
...
test('sectionize with flatten option', function (t) {
  const document = `
# Heading 1
